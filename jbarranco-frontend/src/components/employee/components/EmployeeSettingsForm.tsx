...
import { EmployeeSettingsFormData } from "../hooks/useEmployeeSettings";

interface EmployeeSettingsFormProps {
    readonly formData: EmployeeSettingsFormData;
            ...
            <div className="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                <div className="sm:col-span-4">
                    ...
                    <p className="mt-2 text-xs text-gray-500">
                        Si cambias el correo, tendrás que usar el nuevo para
                        iniciar sesión.
                    </p>
                </div>
