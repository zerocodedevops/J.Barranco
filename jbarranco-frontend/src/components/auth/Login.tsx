...
function Login() {
  ...
  const handleResetPassword = async (e: React.FormEvent) => {
      ...
      try {
          ...
          console.error(err);
          // Firebase error type check simulation
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center">
        <img src="/logo-light.png" alt="J.Barranco Logo" className="h-20 w-auto mx-auto mb-4" />
        <h2 className="text-center text-3xl font-bold brand-blue">
             {isResetting ? "Recuperar Contraseña" : "Acceso Clientes y Empleados"}
        </h2>
